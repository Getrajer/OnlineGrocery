...
namespace OnlineGrocery.Migrations
{
    ...
    [Migration("20200728172154_Inbox Extension")]
    partial class InboxExtension
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineGrocery.Models.ChatMessageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGrocery.Models.NoteModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGrocery.Models.OrderItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGrocery.Models.OrderModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("FullItemsAmmount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineGrocery.Models.ShopIncome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGrocery.Models.ShopMessageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MessagesInbox");
                });

            modelBuilder.Entity("OnlineGrocery.Models.ShoppingCartItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGrocery.Models.Statistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AmmountOfUsers")
                        .HasColumnType("int");

                    b.Property<DateTime>("LatestRegisterDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("LatestRegisterName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("OrderMoneyMean")
                        .HasColumnType("float");

                    b.Property<int>("TotalNumberOfOrders")
                        .HasColumnType("int");

                    b.Property<double>("TotalSalesMoney")
                        .HasColumnType("float");

                    b.Property<double>("UsersMeanMoneySpent")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("OnlineGrocery.Models.UserModel", b =>
                {
                    ...
                    b.Property<DateTime>("TimeRegistred")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OnlineGrocery.Models.UserOrderItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserOrdersItems");
                });

            modelBuilder.Entity("OnlineGrocery.Models.UserOrderModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("UserStreetAdress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineGrocery.Models.UserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineGrocery.Models.ShoppingCartItemModel", b =>
                {
                    b.HasOne("OnlineGrocery.Models.ProductModel", "Product")
                        .WithMany()
